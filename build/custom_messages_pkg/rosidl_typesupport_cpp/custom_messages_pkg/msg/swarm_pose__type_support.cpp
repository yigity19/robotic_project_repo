...
static const _SwarmPose_type_support_symbol_names_t _SwarmPose_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_messages_pkg, msg, SwarmPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_messages_pkg, msg, SwarmPose)),
  }
};
...
{
  return &::custom_messages_pkg::msg::rosidl_typesupport_cpp::SwarmPose_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, custom_messages_pkg, msg, SwarmPose)() {
  return get_message_type_support_handle<custom_messages_pkg::msg::SwarmPose>();
}
