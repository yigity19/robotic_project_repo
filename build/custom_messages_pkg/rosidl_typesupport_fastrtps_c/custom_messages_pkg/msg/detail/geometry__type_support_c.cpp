...
#include "custom_messages_pkg/msg/detail/geometry__rosidl_typesupport_fastrtps_c.h"
...
using _Geometry__ros_msg_type = custom_messages_pkg__msg__Geometry;
...
size_t get_serialized_size_custom_messages_pkg__msg__Geometry(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Geometry__ros_msg_type * ros_message = static_cast<const _Geometry__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Geometry__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_messages_pkg__msg__Geometry(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_messages_pkg
size_t max_serialized_size_custom_messages_pkg__msg__Geometry(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_custom_messages_pkg__msg__Geometry(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_messages_pkg, msg, Geometry)() {
