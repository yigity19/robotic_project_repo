...
bool custom_messages_pkg__msg__swarm_pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_messages_pkg.msg._swarm_pose.SwarmPose", full_classname_dest, 45) == 0);
  }
  custom_messages_pkg__msg__SwarmPose * ros_message = _ros_message;
  {  // pose
  ...
  {  // accel
    ...
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'accel'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    geometry_msgs__msg__Vector3 * dest = ros_message->accel.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
...
{
  /* NOTE(esteve): Call constructor of SwarmPose */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_messages_pkg.msg._swarm_pose");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SwarmPose");
