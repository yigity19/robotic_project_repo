...
class Metaclass_SwarmPose(type):
    """Metaclass of message 'SwarmPose'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'custom_messages_pkg.msg.SwarmPose')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__swarm_pose
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__swarm_pose
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__swarm_pose
            cls._TYPE_SUPPORT = module.type_support_msg__msg__swarm_pose
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__swarm_pose
...
class SwarmPose(metaclass=Metaclass_SwarmPose):
    """Message class 'SwarmPose'."""
    ...
    _fields_and_field_types = {
        ...
        'accel': 'sequence<geometry_msgs/Vector3>',
    }
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'accel' field must be a set or sequence and each value of type 'Vector3'"
        self._accel = value
