...
bool custom_messages_pkg__msg__geometry__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_messages_pkg.msg._geometry.Geometry", full_classname_dest, 42) == 0);
  }
  custom_messages_pkg__msg__Geometry * ros_message = _ros_message;
  {  // center
...
PyObject * custom_messages_pkg__msg__geometry__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_messages_pkg.msg._geometry");
